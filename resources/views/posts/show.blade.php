            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <td>
                        ...
                        <td>
                          <a name="" id="" class="btn btn-primary btn-sm"href="{{ asset('postedit/'.$post->id) }}" role="button">Edit</a>
                          <a name="" id="" class="btn btn-danger btn-sm"href="{{ asset('postdelete/'.$post->id) }}" role="button">Delete</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
